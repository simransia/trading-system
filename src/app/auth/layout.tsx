...
const Layout = ({ children }: { children: ReactNode }) => {
  return (
    <div className="bg-auth-bg h-screen w-full bg-cover bg-center">
      <div className="bg-gradient-to-r flex flex-col items-center justify-center from-black/75 to-blue-950/75 w-full h-full bg-opacity-10">
